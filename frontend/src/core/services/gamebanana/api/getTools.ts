...
import { getTimeAgo, extractAuthors, extractThumbnail, extractUserId, extractUserPfp } from '../utils';

export async function getTools(page = 1, perPage = 15): Promise<GameBananaTool[]> {
