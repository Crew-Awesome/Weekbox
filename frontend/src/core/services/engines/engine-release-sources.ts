export interface EngineNightlyAsset {
  workflow: string;
  artifact: string;
}

export interface EngineReleaseSource {
  repository: string;
  ...
  nightly?: {
    branch: string;
    assets: Record<string, EngineNightlyAsset>;
  };
  updates?: {
...
export const ENGINE_RELEASE_SOURCES: Record<string, EngineReleaseSource> = {
  vslice: {
