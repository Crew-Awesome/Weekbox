import "./runtime.mjs";
import { gameBananaApi } from "./src/backend/providers/gamebanana/gamebanana.provider.js";
import { peoApi } from "./src/backend/providers/peo/peo.provider.js";
import * as github from "./src/backend/providers/github/github-release.provider.js";
import { FS } from "./src/backend/services/filesystem.js";
import { appSettings } from "./src/backend/core/system/settings.service.js";
import { getSelectedEngine, setSelectedEngine } from "./src/backend/core/state/state.service.js";
import { parseWeekboxLink } from "./deep-links.mjs";
import { normalizeVersion, compareVersions } from "./src/backend/core/updates/versioning.util.js";
import { appUpdater } from "./src/backend/core/updates/app-updater.service.js";
import * as releaseAssets from "./src/backend/core/updates/release-assets.util.js";
import { syncWindowsProtocolRegistration } from "./src/backend/core/system/windows-protocol.util.js";
import { networkStatus } from "./src/backend/core/system/network-status.service.js";
import * as archiveTransfer from "./src/backend/services/downloads/archive-transfer.service.js";
import * as downloadValidation from "./src/backend/services/downloads/download-validation.util.js";
import * as externalDownloads from "./src/backend/services/downloads/external-download.resolver.js";
import { nativeFetch } from "./src/backend/services/network/native-http.js";
